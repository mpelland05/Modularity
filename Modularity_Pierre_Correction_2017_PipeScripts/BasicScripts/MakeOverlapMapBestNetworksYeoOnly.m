function MakeOverlapMapBestNetworksYeoOnly(files_in,files_out),
%This script makes an overlap map based on individual networks which best fit the Yeo networks. 
...
%			    is the number of the network from the Yeo template
%			    ex: [8 1; 4 2;10 3; 4 4;11 5;9 6;6 7]
...
[hdr tov] = niak_read_vol('/media/thecelticcircle/DataStorage/MammouthSave/Modularity_PierreCorrections_2017/ICA/Comparison2Yeo/Yeo2011_7Networks_MNI152_FreeSurferConformed3mm_manually_cropped.nii.gz');
temp = permute(tov,[1 3 2]);Yeo = temp(:,:,end:-1:1);
