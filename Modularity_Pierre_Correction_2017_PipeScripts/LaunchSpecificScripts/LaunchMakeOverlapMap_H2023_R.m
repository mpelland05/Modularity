...
if side == 1, %left
    ...
    idx = [75321]%[75321 74803 48721]; %lMT 75321; lTipp 74803; lFFA 48721; ltipp2 115986; lother 88529
    seedname = {'lMT'}%{'lMT' 'lTipp' 'lFFA'};
else
...
mscale{1} = {'sci20_scf20' 'sci21_scf21' 'sci22_scf22' 'sci23_scf23'};
