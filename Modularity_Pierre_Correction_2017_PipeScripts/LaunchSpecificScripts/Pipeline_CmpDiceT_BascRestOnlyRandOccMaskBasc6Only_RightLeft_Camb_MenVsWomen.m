...
opt.contrast = {'Male_Versus_Female'};	%Group you want to compared to the others! Simply chance CBxxx and SCxxx for the names of your groups!
opt.numPermutations = 100000;	%Number of permutations to carry to verify statistical significance. 

gpath{2} = '/home/mpelland/database/Modularity_PierreCorrections_2017/Results/BASCRestOnlyCBSCMixedRandOccMaskBasc6Only_CambMenWomen_Right/';
gpath{1} = '/home/mpelland/database/Modularity_PierreCorrections_2017/Results/BASCRestOnlyCBSCMixedRandOccMaskBasc6Only_CambMenWomen_Left/';


pip.opt.psom.path_logs = '/home/mpelland/database/Modularity_PierreCorrections_2017/Results/BASCRestOnlyCBSCMixedRandOccMaskBasc6Only_CambMenWomen_RightLeftLogs/CmpDiceT/';
