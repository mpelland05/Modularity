...
pip.opt.psom.path_logs = '/home/mpelland/database/Modularity_PierreCorrections_2017/Results/BASC_control_RestOnly_CBSCMixed_rand_OccMaskBasc6Only_RightLeftLogs/AvgDiceGen2/';   %<---------------log outputs
...
fn = fieldnames(pipeline2);
for ii = 1:length(st),
   pipeline=pipeline2.(fn{st(ii)});
end
