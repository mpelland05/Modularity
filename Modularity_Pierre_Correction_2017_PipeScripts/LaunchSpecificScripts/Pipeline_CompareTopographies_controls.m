...
nsamp = 9000; %number of samples for the 
...
%%%%%%%%%%%%%%
pipeline = struct();
pip.opt.psom.path_logs = '/home/mpelland/database/Modularity_PierreCorrections_2017/Results/BASC_control_RestOnly_CBSCMixed_rand_OccMaskBasc6Only_RightLeftLogs/CmpTopo2/';   %<---------------log outputs
...
files_out = strcat('/home/mpelland/database/Modularity_PierreCorrections_2017/Results/BASC_control_RestOnly_CBSCMixed_rand_OccMaskBasc6Only_Right2/Samp',num2str(ii),'/OutputCmpTopo.mat');
