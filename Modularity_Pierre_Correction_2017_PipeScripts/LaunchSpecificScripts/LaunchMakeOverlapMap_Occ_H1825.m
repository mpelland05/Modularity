...
if side == 1, %left
    ...
    idx = [75321];%  %lMT 75321; lTipp 74803; lFFA 48721; ltipp2 115986; lother 88529
    seedname = {'LS93'};%{'lMT' 'lTipp' 'lFFA'};
else
    ...
    files_out = '/media/thecelticcircle/MyPassport/MyStudies/Modularity/Modularity_Pierre_Corrections_2017/FutureFigures/CompareMaps/';%general name of file
    idx = [74818]%[78857 54682 102222]; %rMT 78857; rTipp 54682; rother 102222; rtipp2 (high) 74818
...
%mscale{2} = {'sci3_scf3' 'sci4_scf4' 'sci5_scf5' 'sci6_scf6'};


mscalename ={'H1825'} ;%{'H1825' 'L36'};
