...
opt.folder_out = strcat('/home/mpelland/database/Modularity_OC_2016/fmri/','region_growing_RestOnly_CBSCMixed_OccMaskBASC6only_Right/'); 
opt.flag_roi = true; 
...
opt.folder_out = strcat('/home/mpelland/database/Modularity_OC_2016/fmri/','region_growing_RestOnly_CBSCMixed_OccMaskBASC6only_Left/'); 
opt.flag_roi = true; 
opt.region_growing.thre_size = 1000; % The critical size for regions
